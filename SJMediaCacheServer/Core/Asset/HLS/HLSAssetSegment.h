...
- (instancetype)initWithMimeType:(nullable NSString *)mimeType filePath:(NSString *)filePath position:(UInt64)position length:(UInt64)length NS_UNAVAILABLE;
- (instancetype)initWithFilePath:(NSString *)filePath position:(UInt64)position length:(UInt64)length NS_UNAVAILABLE;
- (instancetype)initWithFilePath:(NSString *)filePath position:(UInt64)position NS_UNAVAILABLE;
@end
